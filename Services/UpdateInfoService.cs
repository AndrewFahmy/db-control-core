...
namespace DbControlCore.Services
{
    ...
    {
        private static readonly string _connectionUsage = "db-control.exe u [connection|c] <name> <value>";
        private static readonly string _statusUsage = "db-control.exe u [status|s] <name> <true/false>";
