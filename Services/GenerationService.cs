...
namespace DbControlCore.Services
{
    ...
    {
        private static readonly string _databaseUsage = "db-control.exe g [database|d] <name>";
        private static readonly string _configUsage = "db-control.exe g [config|c] <location>";
